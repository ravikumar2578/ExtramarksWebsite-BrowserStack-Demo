...
public class TeacherLoginTest extends BaseTest {
	...
	@Test(dataProvider = "getTeacherData", testName = "Validating Home Page Title", description = "Verifying Home Page Title on Home Page", priority = 1)
	...
	@Severity(SeverityLevel.BLOCKER)
	@Test(dataProvider = "getTeacherData", testName = "Validating Login Page", description = "Verifying Login page is displayed after click on Sign in button", priority = 2)
	public void verifyLoginPage(Hashtable<String, String> data) {
		try {
			...
			if (clickSignObject instanceof LoginPage) {
				...
				Reporter.log("Login Page is displyed");
	...
	@Severity(SeverityLevel.BLOCKER)
	@Test(dataProvider = "getTeacherData", testName = "Validating Teacher Login", description = "Verifying Teacher is logged in successful", priority = 3)
	public void verifyTeacherLogin(Hashtable<String, String> data) {
		try {
			SoftAssert sAssert = new SoftAssert();
			String actualResult = "";
			...
			assertEquals(actualResult, expectedResult, "Verifying Teacher Login Test Functionality", sAssert);
			sAssert.assertAll();
		} catch (Exception e) {
	...
	@Test(dataProvider = "getTeacherData", testName = "Validating Dashboard Page title", description = "Verifyimg Dashboard Page Title after successful Login", priority = 4)
