...
public class PracticeTest extends BaseTest {
	...
	public void verifyPractice(Hashtable<String, String> data) throws Exception {
		SoftAssert sAssert = new SoftAssert();
		ServiceTest service = new ServiceTest();
		String expectedResult = "Practice_PASS";
		String actualResult = "Practice_PASS";
...
// Service Tab Section on post chapter
																	try {
																		boolean practiceServiceResult = service
																				.verifyPracticeService(data, sAssert);
																		if (practiceServiceResult) {
																	...
																	if (chPg.BackToChapter.size() != 0) {
																		...
																		if (termSubjectDisplay) {
																			...
																			if (termSubjsize2 != 0) {
																				...
																				if (clickTermSubjectResult2) {
																					...
																					if (clickSubSubjectResult3) {
																						System.out.println(
																								"User navigated on Chapter page from Practice/Practice/Test Tab "
																										+ subject + ">>"
																										+ subSubject
																										+ ">>"
																										+ termSubject);
																			...
																			System.out.println(
																					"Back Button is not working or timeLimit Exceeds, User not able to navigated on Sub Subjects from Practice/Practice/Test Tab  "
																							+ subject + ">>"
																							+ termSubject + ">>"
																							+ subSubject);
																			test.log(LogStatus.INFO,
...
// Service Tab Section on chapter												
													...
													actualResult = "Not_able_to_clickElement_on_chapter_Fail " + subject
															+ ">>" + subSubject + ">>" + chapter;
													System.out.println(
															"Not_able_to_clickElement_on_chapter, Location is --> "
																	+ subject + ">>" + subSubject + ">>" + termSubject
																	+ ">>" + chapter);
													test.log(LogStatus.FAIL,
															"Not_able_to_clickElement_on_chapter, Location is --> "
...
//Sub Subject end								
// Chapter start in case sub subject is not present								
							} else {
									...
									for (int ch = 0; ch < chapSize; ch++) {
										...
										if (clickElementchapterResult) {
											...
											// ........Sub Chapter End
												...
												// Service Tab Section on chapter
												try {
													boolean practiceServiceResult = service.verifyPracticeService(data,
															sAssert);
													if (practiceServiceResult) {
												...
												if (chPg.BackToChapter.size() != 0) {
													...
													if (subjectDisplay) {
														...
														System.out.println(
																"Back Button is not working or timeLimit Exceeds, User not able to navigated on Subjects from Practice/Practice/Test Tab  "
																		+ subject);
														test.log(LogStatus.INFO,
																"Back Button is not working or timeLimit Exceeds, User not able to navigated on Subjects from Practice/Practice/Test Tab  "
																		+ subject);
																...
																if (subSubjectDisplay) {
																	...
																	if (subSubjsize2 != 0) {
																		...
																		if (clickElementSubSubjectResult2) {
																			System.out.println(
																					"User navigated on Sub Subjects from Practice/Practice/Test Tab "
																							+ subject + ">>"
																							+ subSubject);
...
//Service Tab Section on chapter												
											...
											actualResult = "Practice_Not_able_to_clickElement_on_chapter_Fail "
													+ subject + ">>" + subSubject + ">>" + chapter;
											System.out.println(
													"Practice_Not_able_to_clickElement_on_Chapter, Location is --> "
															+ subject + ">>" + subSubject + ">>" + chapter);
											test.log(LogStatus.FAIL,
													"Practice_Not_able_to_clickElement_on_Chapter, Location is --> "
															+ subject + ">>" + subSubject + ">>" + chapter);
									...
									actualResult = "Practice_chapter_page_not_display_FAIL";
									System.out.println("Chapter page is not Displayed, Location is --> " + subject
											+ " -- >" + subSubject);
...
//if click on Sub subject Fail								
								...
								actualResult = "Practice_Not_able_to_clickElement_on_Sub_subject_Fail " + subject + ">>"
										+ subSubject;
								System.out.println("Practice_Not_able_to_clickElement_on_subject, Location is --> "
										+ subject + ">>" + subSubject);
								test.log(LogStatus.FAIL,
										"Practice_Not_able_to_clickElement_on_subject, Location is --> " + subject
												+ ">>" + subSubject);
								sAssert.fail("Practice_Not_able_to_clickElement_on_subject, Location is --> " + subject
										+ ">>" + subSubject);
								Thread.sleep(5000);
							}
						}
...
// if clickElement on Subject Fail	
		...
		if (actualResult.equalsIgnoreCase(expectedResult)) {
			...
			test.log(LogStatus.FAIL, "Practice Fail");
		}
		sAssert.assertAll();
