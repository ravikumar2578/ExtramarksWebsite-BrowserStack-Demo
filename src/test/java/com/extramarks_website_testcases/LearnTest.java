...
public class LearnTest extends BaseTest {
	...
	public void verifyLearn(Hashtable<String, String> data) throws Exception {
		SoftAssert sAssert = new SoftAssert();
		ServiceTest service = new ServiceTest();
		String expectedResult = "Learn_PASS";
		String actualResult = "Learn_PASS";
...
// Service Tab Section on post chapter
																	try {
																		boolean learnServiceResult = service
																				.verifyLearnService(data, sAssert);
																		if (learnServiceResult) {
																	...
																	if (chPg.BackToChapter.size() != 0) {
																		...
																		if (termSubjectDisplay) {
																			...
																			if (termSubjsize2 != 0) {
																				...
																				if (clickTermSubjectResult2) {
																					...
																					if (clickSubSubjectResult3) {
																						System.out.println(
																								"User navigated on Chapter page from Learn/Practice/Test Tab "
																										+ subject + ">>"
																										+ subSubject
																										+ ">>"
																										+ termSubject);
																			...
																			System.out.println(
																					"Back Button is not working or timeLimit Exceeds, User not able to navigated on Sub Subjects from Learn/Practice/Test Tab  "
																							+ subject + ">>"
																							+ termSubject + ">>"
																							+ subSubject);
																			test.log(LogStatus.INFO,
...
//Sub Subject end
		...
		//Service Tab Section on post sub chapter											
															try {
																boolean learnServiceResult = service.verifyLearnService(data,
																		sAssert);
																if (learnServiceResult) {
		...
		//Service Tab Section on chapter										
												try {
													boolean learnServiceResult = service.verifyLearnService(data, sAssert);
													if (learnServiceResult) {
														test.log(LogStatus.PASS, this.getClass().getSimpleName()
																+ " Service Pass for  " + subject + ">>" + chapter);
														System.out.println(this.getClass().getSimpleName()
												...
												if (chPg.BackToChapter.size() != 0) {
													...
													if (subjectDisplay) {
														...
														System.out.println(
																"Back Button is not working or timeLimit Exceeds, User not able to navigated on Subjects from Learn/Practice/Test Tab  "
																		+ subject);
														test.log(LogStatus.INFO,
																"Back Button is not working or timeLimit Exceeds, User not able to navigated on Subjects from Learn/Practice/Test Tab  "
																		+ subject);
														...
														clickElement(cp.getSubjectLinks(), subj, "SubjectLinks");
														Thread.sleep(5000);
														clickElement(sp.getTotalTermLinks(), term, "Term Links");
														Thread.sleep(5000);
													}
												} else {
													driver.navigate().back();
																...
																if (subSubjectDisplay) {
																	...
																	if (subSubjsize2 != 0) {
																		...
																		if (clickElementSubSubjectResult2) {
																			System.out.println(
																					"User navigated on Sub Subjects from Learn/Practice/Test Tab "
																							+ subject + ">>"
																							+ subSubject);
...
//Service Tab Section on chapter												
											...
											actualResult = "Learn_Not_able_to_clickElement_on_chapter_Fail " + subject
													+ ">>" + subSubject + ">>" + chapter;
											System.out.println(
													"Learn_Not_able_to_clickElement_on_Chapter, Location is --> "
															+ subject + ">>" + subSubject + ">>" + chapter);
											test.log(LogStatus.FAIL,
													"Learn_Not_able_to_clickElement_on_Chapter, Location is --> "
															+ subject + ">>" + subSubject + ">>" + chapter);
											sAssert.fail("Learn_Not_able_to_clickElement_on_Chapter, Location is --> "
													+ subject + ">>" + subSubject + ">>" + chapter);
											Thread.sleep(5000);
											dp.openstudytab();
											Thread.sleep(5000);
									...
									actualResult = "Learn_chapter_page_not_display_FAIL";
									System.out.println("Chapter page is not Displayed, Location is --> " + subject
											+ " -- >" + subSubject);
									test.log(LogStatus.FAIL, "Chapter page is not Displayed, Location is --> " + subject
											+ " -- >" + subSubject);
...
//if click on Sub subject Fail								
								...
								actualResult = "Learn_Not_able_to_clickElement_on_Sub_subject_Fail " + subject + ">>"
										+ subSubject;
								System.out.println("Learn_Not_able_to_clickElement_on_subject, Location is --> "
										+ subject + ">>" + subSubject);
								test.log(LogStatus.FAIL, "Learn_Not_able_to_clickElement_on_subject, Location is --> "
										+ subject + ">>" + subSubject);
								sAssert.fail("Learn_Not_able_to_clickElement_on_subject, Location is --> " + subject
										+ ">>" + subSubject);
								Thread.sleep(5000);
...
//chapter start --in case sub subject not present on page
						...
						if (chapSize != 0) {
							for (int ch = 0; ch < chapSize; ch++) {
								...
								test.log(LogStatus.INFO, "Main Chapter :  " + chapNo + "  " + chapter);
//clickElementing on chapter
								boolean clickElementchapterResult = clickElement(sp.getMainChapter(), ch,"chapter link");
								if (clickElementchapterResult) {
									chPg.takeScreenShot();
									Thread.sleep(5000);
//sub Chapter
...
// if clickElement on Subject Fail	
		...
		if (actualResult.equalsIgnoreCase(expectedResult)) {
			...
			test.log(LogStatus.FAIL, "Learn Fail");
		}
		sAssert.assertAll();
