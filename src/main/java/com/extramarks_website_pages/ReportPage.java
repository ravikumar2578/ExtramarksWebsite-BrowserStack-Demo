...
public class ReportPage extends BasePage {
	...
	public ReportPage(WebDriver driver, ExtentTest test) throws Exception {
		super(driver, test);
	...
	public HashMap<String, Double> viewReport(String sub, String chap) throws Exception {
		Thread.sleep(3000);
		...
		Thread.sleep(100);
		DataUtil.setData(xls, "StudentReportTest", 1, "Subject", selectedSubject);
		Thread.sleep(100);
		...
		Thread.sleep(100);
		DataUtil.setData(xls, "StudentReportTest", 1, "Chapter", selectedChapter);
		Thread.sleep(2000);
	...
	public List<HashMap<String, String>> Learn() throws Exception {
		ReportPage rp = new ReportPage(driver, test);
		WebDriverWait wt = new WebDriverWait(driver, 60);
	...
	public List<HashMap<String, String>> Practice() throws Exception {
		ReportPage rp = new ReportPage(driver, test);
		WebDriverWait wt = new WebDriverWait(driver, 60);
