...
public class ProfilePage extends BasePage {
	...
	public ProfilePage(WebDriver driver, ExtentTest test) throws Exception {
		super(driver, test);
	...
	public Object editProfile() throws Exception {
	...
	public void changePassword(Hashtable<String, String> data) throws Exception {
		...
		String currPass=String.valueOf(Math.round(Double.parseDouble(data.get("CurrentPassword"))));
		currentPassword.sendKeys(currPass);
		newPassword.clear();
		Thread.sleep(1000);
		test.log(LogStatus.INFO, "Entering NewPassword");
		String newPass=String.valueOf(Math.round(Double.parseDouble(data.get("NewPassword"))));
		newPassword.sendKeys(newPass);
		confirmPassword.clear();
		Thread.sleep(1000);
		test.log(LogStatus.INFO, "Entering ConfirmPassword");
		String confPass=String.valueOf(Math.round(Double.parseDouble(data.get("ConfirmPassword"))));
