...
public class NotificationPage extends BasePage {
	...
	public NotificationPage(WebDriver driver, ExtentTest test) throws Exception {
		super(driver, test);
	...
	public void notificationDecline(Hashtable<String, String> data) throws Exception {
