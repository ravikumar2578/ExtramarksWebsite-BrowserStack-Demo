...
public class AssessmentPage extends BasePage {
	...
	public AssessmentPage(WebDriver driver, ExtentTest test) throws Exception {
		super(driver, test);
	...
	public void AttemptAssessment(String answer) throws InterruptedException, IOException {
	...
	public void Evaluated() throws Exception {
		...
		if(ViewAssessment.size()!=0) {
			clickElement(ViewAssessment,0,"ViewAssessment");
			clickElement(ViewEvaluated,"ViewAssessment");
		}else {
